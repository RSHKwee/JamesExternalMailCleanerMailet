...
public abstract class ProcessorAbstract {
  ...
  /**
   * Returns the message ids. of messages for which processing has been deferred
   * as the recipient could not be found
   * 
   * @return List
   */
   ...
   * - isKeep() must be true - isMarkSeen() must be false
   * 
   * @return boolean
   */
   ...
   */
  public abstract void process() throws MessagingException, MailQueueException;
