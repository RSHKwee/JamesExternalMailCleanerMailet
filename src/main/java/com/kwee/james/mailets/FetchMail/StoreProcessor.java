...
public class StoreProcessor extends ProcessorAbstract {
  ...
  public void process() throws MessagingException {
    ...
    LOGGER.info("Starting fetching mail from server '{}' for user '{}' in folder '{}'", getHost(), getUser(),
    ...
    try {
      ...
      LOGGER.info("Finished fetching mail from server '{}' for user '{}' in folder '{}'", getHost(), getUser(),
          getJavaMailFolderName());
    }
  }
